...
Revision ID: 995a90076bc1
Revises: 72e301ad1550
Create Date: 2020-02-09 07:32:09.934207
...
def upgrade():
    ...
    sa.Column('lat', sa.Numeric(precision=17, scale=15), nullable=True),
    sa.Column('lng', sa.Numeric(precision=17, scale=15), nullable=True),
    ...
    sa.Column('quant_unit', sa.String(), server_default=FetchedValue(), nullable=True),
